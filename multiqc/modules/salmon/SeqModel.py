...
class SeqModel:
    ...
    def populate_model_(self, data_):
        ...
        int64_struct = struct.Struct('@P')

        first = int_struct.unpack_from(data_[offset:])[0]
    ...
    def from_file(self, dname):
        ...
        try:
            ...
            self.obs3_weights_, self.obs3_ = self.populate_model_(obs3_dat)
        except IOError:
        ...
        try:
            ...
            self.exp3_weights_, self.exp3_ = self.populate_model_(exp3_dat)
        except IOError:
        ...
        try:
            ...
            self.obs5_weights_, self.obs5_ = self.populate_model_(obs5_dat)
        except IOError:
        ...
        try:
            ...
            self.exp5_weights_, self.exp5_ = self.populate_model_(exp5_dat)
        except IOError:
